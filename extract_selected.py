...
# ______________________________________________________________________________
    ...
    xs = fitted[sub_colors[:] != -1, 0]
    ys = fitted[sub_colors[:] != -1, 1]
    zs = fitted[sub_colors[:] != -1, 2]

    sub_colors = sub_colors[sub_colors[:] != -1] # deleting the noise
